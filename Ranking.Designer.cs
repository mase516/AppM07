namespace PrimeraApp
{
    partial class Ranking
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel1.Location = new Point(110, 176);
            ...
            label3.TabIndex = 2;
            label3.Text = "Puntos Jornada";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.BackColor = Color.White;
            label4.Location = new Point(468, 0);
            label4.Name = "label4";
            label4.Size = new Size(134, 15);
            label4.TabIndex = 3;
            label4.Text = "Puntos Jornada Anterior";
            // 
            // label1
            // 
            ...
            label5.Location = new Point(113, 104);
            label5.Name = "label5";
            label5.Size = new Size(90, 15);
            label5.TabIndex = 2;
            label5.Text = "RECOMPENSAS";
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.BackColor = Color.FromArgb(255, 255, 128);
            label6.Location = new Point(113, 130);
            label6.Name = "label6";
            ...
            label7.TabIndex = 4;
            label7.Text = "Top 2 - 10 =";
            // 
            // label8
            // 
            label8.AutoSize = true;
            label8.BackColor = Color.FromArgb(255, 192, 128);
            label8.Location = new Point(298, 130);
            label8.Name = "label8";
            label8.Size = new Size(82, 15);
            label8.TabIndex = 5;
            label8.Text = "Top 11 - 100 =";
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.BackColor = Color.FromArgb(128, 255, 255);
            label9.Location = new Point(405, 130);
            label9.Name = "label9";
            label9.Size = new Size(77, 15);
            label9.TabIndex = 6;
            label9.Text = "Top 101 - 250";
            // 
            // label10
            // 
            label10.AutoSize = true;
            label10.BackColor = Color.FromArgb(255, 128, 255);
            label10.Location = new Point(503, 130);
            label10.Name = "label10";
            label10.Size = new Size(91, 15);
            label10.TabIndex = 7;
            label10.Text = "Top 251 - 500 = ";
            // 
            // label11
            // 
            label11.AutoSize = true;
            label11.BackColor = Color.FromArgb(128, 255, 128);
            label11.Location = new Point(618, 130);
            label11.Name = "label11";
            label11.Size = new Size(83, 15);
            label11.TabIndex = 8;
            label11.Text = "Top 500 - 1000";
