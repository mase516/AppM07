namespace PrimeraApp
{
    partial class Mercado
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel1.Location = new Point(166, 166);
            tableLayoutPanel1.Name = "tableLayoutPanel1";
            tableLayoutPanel1.RowCount = 5;
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 18.0790958F));
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 21.4689274F));
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 20F));
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 20F));
            tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 20F));
            tableLayoutPanel1.Size = new Size(517, 177);
            ...
            label3.TabIndex = 2;
            label3.Text = "Puntos Ultima Jornada";
            // 
            // label4
            // 
            ...
            label5.TabIndex = 4;
            label5.Text = "Equipo Actual";
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.BackColor = Color.FromArgb(0, 192, 0);
            label6.Location = new Point(248, 23);
            label6.Name = "label6";
            ...
            label7.Location = new Point(208, 23);
            label7.Name = "label7";
